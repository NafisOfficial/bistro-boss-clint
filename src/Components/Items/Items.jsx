...
const Items = ({ Item,title }) => {
    return (
        <div>
            ...
            <Link to={`/order/${title}`}><button className="btn block mx-auto border-0 border-b-4 btn-outline text-center mb-4 uppercase">Offer your favorite food</button></Link>
        </div>
    );
};
